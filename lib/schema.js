...
export default class Schema {
   ...
   * JSON-type objects and arrays are stringified; boolean values are
   * converted to 1/0 (SQLite has no native boolean type). All other
   * types pass through. This is the inverse of coerceValue, which
